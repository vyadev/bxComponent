...
?>
    ...
    <div class="sort">Сортировать по:
      ...
      <?if($_REQUEST["sort"] == "hit"):?>
        <!-- сортировка по количеству заказов товара-->
        <?$sort = "PROPERTY_ORDER_COUNT"?>

        <!--сортировка по количеству товаров в корзине-->
        <?/*$sort = "PROPERTY_CART_COUNT"*/?>
        <span>популярности</span>
      <?else:?>
        <a href="<?=$APPLICATION->GetCurPageParam("sort=hit", array("sort"))?>">популярности</a>
      <?endif;?>|
      ...
      <?if($_REQUEST["sort"] == "price"):?>
        ...
        <span>цене</span>
      <?else:?>
        <a href="<?=$APPLICATION->GetCurPageParam("sort=price", array("sort"))?>">цене</a>
      <?endif;?>|
      ...
      <?if($_REQUEST["by"] == "desc"):?>
        ...
        <span>убыванию</span>
      <?else:?>
        <a href="<?=$APPLICATION->GetCurPageParam("by=desc&clear_cache=Y", array("by", "clear_cache"))?>">убыванию</a>
      <?endif;?>|
      ...
      <?else:?>
        <a href="<?=$APPLICATION->GetCurPageParam("by=asc&clear_cache=Y", array("by", "clear_cache"))?>">возрастанию</a>
      <?endif;?>
    </div>
